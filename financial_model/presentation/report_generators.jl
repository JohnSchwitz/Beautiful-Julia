...
function generate_founder_capitalization_file(plan, milestones, initial_tasks, hours, nebula_f, disclosure_f, lingua_f, prob_params)
    open("NLU_Founder_Capitalization.md", "w") do file
        ...
        write(file, "| Shareholder | Shares | % (Diluted) | Value @ \$2M pre |\n")
        write(file, "|-------------|--------|-------------|------------------|\n")
        write(file, "| Founder | 4,000,000 | 68.0% | \$1,530K |\n")
        write(file, "| SAR Plan | 400,000 | 6.8% | \$153K |\n")
        write(file, "| Angel Investors | 735,294 | 12.5% | \$250K |\n")
        write(file, "| **Allocated** | **5,135,294** | **87.3%** | |\n")
        write(file, "| **Available for Series A** | **750,000** | **12.7%** | |\n")
        write(file, "| **Total Outstanding** | **5,885,294** | **100.0%** | \$2,250K post-money |\n\n")
